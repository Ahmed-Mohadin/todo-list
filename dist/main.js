            ...
            if(project.title == title){
                ...
                this.projects.forEach((prj) => {
                    ...
                    prj.todos.forEach((todo) => {
                        const taskDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(todo.date));
                        switch(title){
                            case 'All Tasks':
                                project.todos.push(todo);
                                break;
                            case 'Today':
                                if((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(taskDate)) project.todos.push(todo);
                                break;
                            case 'This Week':
                                if((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(taskDate, 1))) project.todos.push(todo);
                                break;
                            case 'Important':
...
/* harmony import */ var _uiContent__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./uiContent */ "./src/modules/uiContent.js");
...
const ui = (() => {
    ...
    const initPage = () => {
        ...
        _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].renderProjects(collection);
        _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].getTodos(collection, _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].getSelected().id);
        initPageEvents();
    }
    ...
    const initPageEvents = () => {
        ...
        defaultProject.forEach((project) => {
            project.onclick = () => {
                _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].selectProject(project);
                _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].getTodos(collection, project.id);
                initTodoEvents();
    ...
    const initProjectEvents = () => {
        ...
        userProjects.forEach((project) => {
            ...
            project.addEventListener('click', (e) => {
                ...
                _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].selectProject(project);
                _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].renderTodos(collection, project.id);
        ...
        userTodos.forEach((todo) => {
            todo.addEventListener('click', (e) => {
                ...
                if(e.target.classList.contains('fa-circle-check')){
                    ...
                    _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].checkProjectId(collection);
                    initTodoEvents();
    ...
    const handleCreateProject = () => {
        if(collection.titleTaken(projectName.value)){
            _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].createErrorText('form-project', 'Project Already Exist');
            ...
            _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].createErrorText('form-project', 'Invalid Project');
        }
    }
    ...
    const handleEditProject = () => {
        ...
        if(collection.titleTaken(nameValue) && nameValue !== _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].getSelected().innerText){
            _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].createErrorText('form-project', 'Project Already Exist');
        } else if(projectName.value !== ''){
            collection.editProject(projectName.value, _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].getSelected().id);
            collection.saveProjects();
            _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].displayTitle(projectTitle, nameValue);
            _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].renderProjects(collection);
            initProjectEvents();
            closeForm();
        } else{
    ...
    const handleDeleteProject = () => {
        collection.deleteProject(_uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].getSelected().id);
        collection.saveProjects();
        _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].renderProjects(collection);
        _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].selectProject(document.querySelector('#all-tasks'));
        _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].getTodos(collection, document.querySelector('#all-tasks').id);
        initProjectEvents();
    }
    ...
    const handleCreateTodo = () => {
        if(todoTitle.value !== ''){
            const toDate = todoDate.value == '' ? 'No Due Date' : (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(todoDate.value), 'yyyy-MM-dd');
            collection.addTodo(todoTitle.value, toDate, todoImportant.checked, _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].getSelected().id);
            collection.saveProjects();
            _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].renderTodos(collection, _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].getSelected().id);
            initTodoEvents();    
            closeForm();
        } else{
            _uiContent__WEBPACK_IMPORTED_MODULE_2__["default"].createErrorText('form-todo', 'Invalid Todo');
        }
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (uiContent);
